#!/usr/bin/env python3
"""
Exercise 2: Data Processing with HDFS
Level: Intermediate
...
def exercise2():
    ...
    try:
        ...
        print(f"Error calculating statistical summaries: {e}")
    ...
    try:
        ...
        print("Directory created: /exercises/exercise2/")
    except Exception as e:
    ...
    try:
        ...
        with hdfs.write('/exercises/exercise2/high_salary_employees.csv', encoding='utf-8') as writer:
            writer.write(high_salary_csv)
        print("File saved: /exercises/exercise2/high_salary_employees.csv")
    except Exception as e:
    ...
    try:
        ...
        with hdfs.write('/exercises/exercise2/city_analysis.json', encoding='utf-8') as writer:
            writer.write(city_json)
        print("File saved: /exercises/exercise2/city_analysis.json")
    except Exception as e:
        print(f"Error saving file: {e}")
        raise e
...
"""
        with hdfs.write('/exercises/exercise2/analysis_report.txt', encoding='utf-8') as writer:
            writer.write(report)
        print("File saved: /exercises/exercise2/analysis_report.txt")
    except Exception as e:
